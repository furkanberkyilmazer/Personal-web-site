    ...
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            <div class="image">
              <img src="assets/images/berk2.jpg" alt="" />
            </div>
            <div class="author-content">
              <h4>Furkan Berk Yılmazer</h4>
        ...
        <div class="container">
          <div class="section-heading">
            ...
            <div class="line-dec"></div>
              ...
              ><b>1997 İstanbul doğumluyum , teknik lise bilişim teknolojileri bölümünden mezun oldum daha sonra İstanbul Arel Üniversitesi Bilgisayar Programcılığını tam burslu olarak bitirdim. Ardından Bülent Ecevit Üniversitesi Bilgisayar Mühendisliği Bölümüne geçiş yaptım. Toplam 9 sene Bilişim üzerine eğitim aldım. C , C# , C++, Java olmak üzere bir çok dilde çeşitli projeler geliştirdim. İyi seviyede SQL veri tabanı bilgisine sahibim. Çok sayıda Otomasyon program ve Web sitesi hazırladım.</span></div>
           </b>
          </div>
          <div class="left-image-post">
            <div class="row">
              <div class="col-md-6">
                <div>
                  <img src="assets/images/mezun.jpg" style="width:500px;height: 400px"/>
                </div>
              </div>
              <div class="col-md-6">
                <div class="right-text">
                  <h4>Eğitimlerim</h4>
                  <p>                   
Bülent Ecevit Üniversitesi &ensp;-&ensp; Bilgisayar Mühendisliği  <br />Başlangıç Tarihi &ensp;&ensp; Bitiş Tarihi  <br />09.2018&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;     02.2022
                  </p>
                    <p>                   
İstanbul Arel Üniversitesi &ensp;-&ensp; Bilgisayar Programcılığı  <br />Başlangıç Tarihi &ensp;&ensp; Bitiş Tarihi  <br />08.2015&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;     09.2017
                  </p>
      ...
      <section class="section my-work" data-section="section3">
        <div class="container">
          <div class="section-heading">
            ...
            <div class="line-dec"></div>
            <span
              >Asp.Net ve MySql ile Geliştirilmiş Giyim Satış Sitesi(E-Ticaret)
                <br />
 	C# yazılım dili ve MySql kullanarak Otopark Takip Sistemi
                <br />
	C# yazılım dili ve MySql kullanarak  Antrenman Takip ve Muhasebe Sistemi
                <br />
	C++ yazılım dili ve MySql kullanarak Otobüs Rezervasyon Sistemi</span
            >
          </div>
            <h5  style="text-align:center">E-ticaret sitesinden birkaç görsel</h5>

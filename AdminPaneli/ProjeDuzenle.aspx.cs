...
{
    public partial class ProjeDuzenle : System.Web.UI.Page
    {
        string projeId;
        string islem;
        string projeFoto;
        ...
        { 
...

            {
                ...
                if (islem == "sil")
                {
                    ...
                    bag.Close();
                    Response.Redirect("ProjeDuzenle.aspx?projeId=" + id.ToString());
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ProjeDuzenle.aspx?projeId=" + projeId);
        }
    }
}